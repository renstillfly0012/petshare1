                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10 offset-md-1">
                                ...
                                <label for="password" class="col-md-4 offset-md-4 col-form-label text-md-center">{{ __('Password') }}</label>
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10 offset-md-1">
                                ...
                                <label for="password-confirm" class="col-md-4 offset-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}</label>
